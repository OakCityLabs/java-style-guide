# The Official Oak City Labs Java Style Guide

Our overarching goals are __conciseness__, __readability__ and __simplicity__.

You should also check out the [Kotlin](https://github.com/oakcitylabs/kotlin-style-guide)
style guide too.
...
a rather complex sequence of menus. To make it easier, you can use the raywenderlich coding
...
This style guide is based off of (forked from) the raywenderlich.com [Java style guide](https://github.com/raywenderlich/java-style-guide):
